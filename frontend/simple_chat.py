...
def chat_llm(input_messages, model='mistral/mistral-small-latest'):
...
def simple_chat(style_guide):
    ...
    system_prompt = f"""
        You are a helpful assistant that response to user query using the defined style guide.
